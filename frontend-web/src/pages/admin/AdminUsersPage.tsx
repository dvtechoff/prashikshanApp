...
export default function AdminUsersPage() {
  ...
  const filteredUsers = users.filter((user: User) => {
    const name = user.name || user.industry_profile?.company_name || '';
                  ...
                  >
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="flex items-center">
                        <div className="w-10 h-10 bg-gradient-to-br from-purple-500 to-pink-500 rounded-full flex items-center justify-center text-white font-semibold">
                          {(user.name || user.industry_profile?.company_name || user.email)[0].toUpperCase()}
                        </div>
                        <div className="ml-3">
                          <div className="text-sm font-medium text-gray-900">
                            {user.name || user.industry_profile?.company_name || 'No Name'}
                          </div>
                          {user.phone && (
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <button
                        ...
                        className={`inline-flex items-center gap-1 px-3 py-1.5 text-xs font-semibold rounded-full transition-all disabled:opacity-50 disabled:cursor-not-allowed ${
                          user.is_active
